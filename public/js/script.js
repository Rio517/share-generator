...
$(document).ready(function(){
      $('#fb_type').change(function(){
        var samples = {button: '<img src="http://sphotos.ak.fbcdn.net/hphotos-ak-ash2/hs329.ash2/60892_444262393552_19292868552_5172535_910697_n.jpg" />',
        ...
        var target = $('#sample_link');
        if($(this).val()==''){
          target.html('<a href="#">Example Text</a>');
        }else{
          target.html(samples[$(this).val()]);
        }
      });
    });
  function shareFB() {
